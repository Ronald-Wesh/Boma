...
const TenantDashboard = () => {
  ...
  const [myBuildings, setMyBuildings] = useState([]); // e.g., listings the tenant is part of
  ...
  // Fetch forum posts for selected building
  useEffect(() => {
    if (selectedListing) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-100 to-slate-200 dark:from-zinc-900 dark:to-slate-800">
      <div className="max-w-4xl mx-auto py-8">
        ...
        <div className="mb-8">
          ...
          <ul className="bg-zinc-100 dark:bg-zinc-900 rounded p-2">
            {myBuildings.map(b => (
          ...
          <>
            <div className="mb-8">
              ...
              <form onSubmit={handleForumPost} className="flex gap-2 mb-2">
                <input
                  className="flex-1 border border-zinc-300 bg-zinc-50 rounded px-2 py-1 text-zinc-700"
                  value={newForumPost}
            ...
            <div className="mb-8">
              ...
              <form onSubmit={handleReview} className="flex flex-col gap-2">
                <input
                  ...
                  className="border border-zinc-300 bg-zinc-50 rounded px-2 py-1"
                  required
                />
                <input
                  type="number"
